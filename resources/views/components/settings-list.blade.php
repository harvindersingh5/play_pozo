<table class="table user-table table-hover align-items-center">
    <thead>
        <tr>
            ...
            <th class="border-bottom">Width</th>
            <th class="border-bottom">Height</th>
    ...
    <tbody>
        @forelse ($settings as $index => $setting)
            <tr>
                ...
                <td>
                    <span class="fw-normal">{{ $setting['name'] ?? 'N/A' }}</span>
                </td>
                <td>
                    <span class="fw-normal">{{ $setting['width'] ?? 'N/A' }}</span>
                </td>
                <td>
                    <span class="fw-normal">{{ $setting['height'] ?? 'N/A' }}</span>
                </td>
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                            <a class="dropdown-item d-flex align-items-center gap-1"
                                href="{{ route('admin.settings.thumbnail.edit', $index) }}">
                            ...
                            <a class="dropdown-item text-danger d-flex align-items-center gap-1" href="#"
                                onclick="confirmDelete(event, '{{ route('admin.settings.thumbnail.delete', $index) }}', 'Are you sure you want to delete this size?')">
