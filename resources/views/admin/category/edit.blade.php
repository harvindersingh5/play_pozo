            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.category.index') }}">Categories List</a></li>
        ...
        <div class="row">
            <div class="col-12 col-xl-8">
                <div class="card card-body shadow-sm mb-4">
                    <form action="{{ route('admin.category.update', jsencode_userdata($category->id)) }}" method="POST" id="create-category"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control mb-0 @error('parent_id') is-invalid @enderror"
                                        id="parent_id" name="parent_id">
                                        <option value="">Select parent category</option>
                                        @foreach ($categories as $allcategory)
                                            @php
                                                $isSameCategory = $category->id == $allcategory->id ? true : false;
                                            @endphp
                                            <option value="{{ $allcategory->id }}"
                                                {{ $category->parent_id == $allcategory->id ? 'selected' : '' }}
                                                {{ $isSameCategory ? 'disabled' : '' }}
                                                class="{{ $isSameCategory ? 'disabled-option' : '' }}">
                                    ...
                                    <div class="file-field">
                                        <div class="d-flex justify-content-xl-center ms-xl-3">
                                            <div class="d-flex">
                                                ...
                                                <input type="file" name="category_image" form="create-category"
                                                accept="image/*" id="category_image">
