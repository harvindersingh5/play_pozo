            ...
            $(document).ready(function() {
                ...
                $('#applyUserBtn').on('click', function() {
                    ...
                    if (planIds.length > 0) {
                        ...
                        let url = '{{ route('admin.plan.apply') }}';
                        let data = {
                            plan_ids: planIds,
                        ...
                        response.then((response) => {
                            if (response.status == true) {
                                $("#userList").html(response.html);
                                toastMsg('success', 'Plan status updated successfully', '#262B40');
                            } else {
                        ...
                        toastMsg('error', 'Please select atleast one plan', '#FA5252');
                    }
                });
            });
        </script>
