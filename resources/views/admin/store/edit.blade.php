            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.store.index') }}">Store List</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Store</li>
                    </ol>
                </nav>
                <h2 class="h4">Edit Store</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-xl-8">
                <div class="card card-body shadow-sm mb-4">
                    <form action="{{ route('admin.store.update', [$store->id]) }}" method="POST" id="store-create"
                            ...
                            <div class="col-md-12 mb-3">
                                <div>
                                    ...
                                    <input class="form-control @error('store_name') is-invalid @enderror"
                                        id="store_name" type="text" placeholder="Name"
                                    ...
                                    <select
                                        ...
                                        @foreach ($vendores as $vendore)
                                            <option value="{{ $vendore->id }}"
                                                {{ $store->vendor->id == $vendore->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-12 mb-3">
                                <div>
                                    ...
                                    <input class="form-control @error('location') is-invalid @enderror" id="location"
                                        type="text" placeholder="Location" name="location" value="{{ $store->location }}">
                                    @error('location')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
