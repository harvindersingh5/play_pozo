            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active">Favicon
                        </li>
                    </ol>
                </nav>
                <h2 class="h4">Favicon</h2>
            </div>
        </div>
            ...
            <div class="col-12 col-xl-4">
                <div class="row">
                    <div class="col-12 mb-4">
                        <form action="{{ route('admin.settings.favicon.store') }}" method="POST"
                            enctype="multipart/form-data" id="favicon-form">
                            @csrf
    ...
    @push('scripts')
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                handleValidation('favicon-form', rules, messages);
                ...
                $('#favicon-form').on('submit', function(event) {
                    if ($('#favicon-form').valid() && isValid) {
