        ...
        <div class="row">
            <div class="col-12 col-xl-6">
                <div class="card card-body shadow-sm mb-4">
                    <form action="{{ route('admin.settings.thumbnail.update', $index) }}" method="POST"
                        id="create-size">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="mt-3">
                            <button type="submit"
                                class="btn btn-gray-800 mt-2 animate-up-2 save-all-btn">Update</button>
                        </div>
                    </form>
                </div>
            </div>
