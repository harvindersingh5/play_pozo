<x-admin-layout>
    @section('title', 'Edit Stripe Details')
            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Stripe Details</li>
                    </ol>
                </nav>
                <h2 class="h4">Edit Stripe Details</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-xl-12">
                <div class="card card-body shadow-sm mb-4">
                    <form method="POST" action="{{ route('admin.payment-settings.update', ['setting' => $setting->id]) }}" id="payment-settings">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="input-group form-feild">
                                        <input type="text" name="public_key" id="publicKey"
                                            ...
                                            placeholder="********" value="{{ old('public_key', $setting->public_key['original'] ?? '') }}">
                                ...
                                <div>
                                    ...
                                    <div class="input-group form-feild">
                                        <input type="text" name="secret_key" id="secretKey"
                                            ...
                                            placeholder="********" value="{{ old('secret_key', $setting->secret_key['original'] ?? '') }}">
                                        <span class="input-group-text">
                                            <svg width="17" height="9" viewBox="0 0 17 9" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <button type="submit" class="btn btn-primary confirm-button" disabled>Update</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="row">
            <div class="col-12 col-xl-12">
                <div class="card card-body shadow-sm mb-4">
                    <form method="POST" action="{{  route('admin.payment-settings.update', ['setting' => $setting->id]) }}"
                        id="payment-settings-form">
                        @csrf
                        @method('PUT')
                        <ul class="nav nav-tabs" id="paymentMethodTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $type == 'stripe' ? 'active' : '' }}" id="stripe-tab" data-bs-toggle="tab"
                                    data-bs-target="#stripe-panel" type="button" role="tab"
                                    aria-controls="stripe-panel" aria-selected="true">Stripe</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link {{ $type == 'paypal' ? 'active' : '' }}" id="paypal-tab" data-bs-toggle="tab"
                        ...
                        <div class="tab-content" id="paymentMethodTabContent">
                            <div class="tab-pane fade {{ $type == 'stripe' ? 'show active' : '' }}" id="stripe-panel" role="tabpanel"
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group form-feild">
                                                    <input type="text" name="public_key" id="stripe_public_key"
                                                        ...
                                                        value="{{old('public_key', $setting->public_key['original'] ?? '') }}">
                                                    <span class="input-group-text">
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group form-feild">
                                                    <input type="text" name="secret_key" id="stripe_secret_key"
                                                        ...
                                                        value="{{ old('secret_key', $setting->secret_key['original'] ?? '') }}">
                                                    <span class="input-group-text">
                                                        <svg width="17" height="9" viewBox="0 0 17 9"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                            ...
                            <div class="tab-pane fade {{ $type == 'paypal' ? 'show active' : '' }}" id="paypal-panel" role="tabpanel"
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group form-feild">
                                                    <input type="text" name="paypal_client_id"
                                                        ...
                                                        value="{{ old('paypal_client_id', $setting->paypal_client_id['original'] ?? '') }}">
                                                    <span class="input-group-text">
                                            ...
                                            <div>
                                                ...
                                                <div class="input-group form-feild">
                                                    <input type="text" name="paypal_client_secret"
                                                        ...
                                                        value="{{ old('paypal_client_secret', $setting->paypal_client_secret['original'] ?? '') }}">
                                                    <span class="input-group-text">
