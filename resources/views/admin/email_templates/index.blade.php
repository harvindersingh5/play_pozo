<x-admin-layout>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Email Templates List</h2>
        </div>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        ...
        <div class="card-body">
            <div id="userList">
                <x-email-templates-list :templates="$templates" />
            </div>
        </div>
    </div>
    </section>
            ...
            $(document).ready(function() {
                ...
                $('#applyUserBtn').on('click', function() {
                    ...
                    if (templateIds.length > 0) {
                        ...
                        let url = '{{ route('admin.email-templates.apply') }}';
                        let data = {
                        ...
                        response.then((response) => {
                            if (response.status == true) {
                                $("#userList").html(response.html);
                                toastMsg('success', 'Template status updated successfully', '#262B40');
                            } else {
                        ...
                        toastMsg('error', 'Please select atleast one template', '#FA5252');
                    }
                });
            });
        </script>
