            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.email-templates.index') }}">Email Template
                                List</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Email Template</li>
                    </ol>
                </nav>
                <h2 class="h4">Add Email Template</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-xl-8">
                <div class="card card-body shadow-sm mb-4">
                    <form action="{{ route('admin.email-templates.store') }}" method="POST" id="create-email-template"
                        enctype="multipart/form-data">
                        {{-- Hidden input for Quill content --}}
                        @csrf

                        {{-- Include the shared form partial --}}
                        @include('admin.email_templates._form', ['emailTemplate' => null]) {{-- Pass null for creation --}}
            ...
            {{-- Helper Sidebar --}}
            @include('admin.email_templates._helper_sidebar') {{-- Moved helper sidebar to its own partial too --}}
        </div>
    </div>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // The `quill.root.innerHTML` is populated directly in the partial.
                // We only need to handle `old()` here if the form submission failed.
                ...
                // const form = document.getElementById('create-email-template');
