...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            const $sidebarToggleLarge = $('#sidebar-toggle');
            ...
            const toggleSidebar = () => {
                ...
                localStorage.setItem('sidebarCollapsed', $sidebarMenu.hasClass('collapsed'));
            };

            if ($sidebarToggleLarge.length) {
                $sidebarToggleLarge.on('click', toggleSidebar);
            }

            if ($sidebarToggleMobile.length) {
                $sidebarToggleMobile.on('click', toggleSidebar);
            }

            // Check for previously stored state
